...
#         "Product ID": product_code,          # ✅ pakai Product Code
#         "SKU ID": ean,                       # ✅ pakai EAN
...
#         with open("superdrug_products.csv", "w", newline="", encoding="utf-8") as f:
...
#                 for sub in targets:
#                     print(f"  ↳ {sub['name']}")
#                     products = get_product_links(page, sub["url"])  # sudah list of URLs
#                     for prod in products:
#                         details = page_details(page, prod, major_category=cat["name"])
#                         writer.writerow(details)
#                         print("   →", details["Product URL"])
