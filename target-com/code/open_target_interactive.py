...
# ---------- CONFIG ----------
URL = "https://www.target.com/p/e-l-f-glitzshow-eyeshadow-stick-1-3-fl-oz/-/A-94742778?preselect=94611703#lnk=sametab"
HEADLESS = False
PROXY = {
    "server": "http://dc.decodo.com:10000",
    "username": "user-scraping-country-us",
    "password": "Zg1wsoj_6A1hdI6orG"
}
    ...
    try:
        ...
        for i, item in enumerate(items, start=1):
            try:
                ...
                if href:
                    print(f"   → https://www.target.com{href}")
