...
# ---------- KONFIG ----------
PROXIES = [
    {"server": "191.96.254.80:6127", "username": "arssrhsq", "password": "x1vpi09f4v1g"},
...
# https://redsky.target.com/redsky_aggregations/v1/web/plp_search_v2?category=5xszd&count=24&default_purchasability_filter=true&include_sponsored=true&include_review_summarization=true&offset=0&page=%2Fc%2F5xszd&platform=desktop&pricing_store_id=2250&spellcheck=true&store_ids=2250%2C772%2C2175%2C2138%2C1857&visitor_id=019CFA2A0A070200A381BD2602D2BA4E&scheduled_delivery_store_id=2250&zip=22716&key=9f36aeafbe60771e321a7cc95a78140772ab3e96&channel=WEB&include_dmc_dmr=true&useragent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F145.0.0.0+Safari%2F537.36


def fetch_plp_page(offset):
    # Data terbaru dari inspect element Anda
    visitor_id = '019CFA2A0A070200A381BD2602D2BA4E'
    api_key = '9f36aeafbe60771e321a7cc95a78140772ab3e96'
    store_id = '2250'
    
    # URL yang sudah disesuaikan dengan browser
    url = (
        "https://redsky.target.com/redsky_aggregations/v1/web/plp_search_v2"
        f"?category=5xszd&count=24&default_purchasability_filter=true"
        "&include_sponsored=true&include_review_summarization=true"
        f"&offset={offset}&page=%2Fc%2F5xszd&platform=desktop"
        f"&pricing_store_id={store_id}&spellcheck=true"
        f"&store_ids={store_id}%2C772%2C2175%2C2138%2C1857"
        f"&visitor_id={visitor_id}&scheduled_delivery_store_id={store_id}"
        "&zip=22716&channel=WEB&include_dmc_dmr=true"
        f"&key={api_key}"
    )
    
    r = session.get(url, timeout=REQUEST_TIMEOUT)
    
    # Debugging: Jika masih error, print pesan error dari server
