...
base_api_url = "https://www.neimanmarcus.com/c/dt/api/productlisting?categoryId=cat10470822"
all_product_urls = []
...
for page in range(1, 2):
    ...
    current_url = f"{base_api_url}&page={page}?navpath=cat000000_cat000285_cat55180733_cat51180746_cat10470822&source=leftNav"
