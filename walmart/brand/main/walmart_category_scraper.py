...
if __name__ == "__main__":
    ...
    BASE_URL = "https://www.walmart.com/browse/single-serve-adult-beverages/0/0/"
    ...
    PARAMS = "_refineresult=true&_be_shelf_id=2402802&search_sort=100&facet=shelf_id:2402802&povid=976759_hubspoke_2975985_Rollbacksandmore_Singleserve_Rweb_Apr_04"
    ...
    for page_num in range(1, MAX_PAGES + 1):
        page_url = f"{BASE_URL}?{PARAMS}&page={page_num}&affinityOverride=default"
