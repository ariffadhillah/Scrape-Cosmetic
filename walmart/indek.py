...
# import time
# import json
# # --- FUNGSI PENGAMBILAN URL VARIAN (SAMA SEPERTI SEBELUMNYA) ---
...
#         print(f"❌ Kesalahan saat mengambil URL utama ({base_url}): {e}")
#         return []

# # --- FUNGSI BARU: MENGAMBIL TITLE DARI URL VARIAN ---


# # ... (Fungsi ekstrak_dan_filter_urls_walmart tetap sama) ...

# # --- FUNGSI BARU: MENGAMBIL TITLE DARI URL VARIAN ---

# def ambil_title_dari_url(url, title_id="main-title"):
#     """
#     Mengunjungi URL varian dan mencoba mencari title menggunakan ID atau Class yang unik.
#     """
#     try:
#         headers = {
#             'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36',
...
#         # 2. Coba cari berdasarkan Class yang sering digunakan oleh title Walmart
#         # Menggunakan class yang Anda tunjukkan: dark-gray mv1 lh-copy f4 mh0 b
...
#         # Jika kedua metode HTML gagal, hampir pasti data ada di JSON
...
#     except KeyError:
#         return "Title Tidak Ditemukan (Gagal di HTML dan JSON)" # Jika kunci JSON salah
#     except Exception as e:
#         return f"Kesalahan Lain: {e}"

# # --- Proses Utama (Lanjutkan dengan kode yang sama) ---
# # ...

# # --- Proses Utama ---

# # URL Utama (yang berisi link ke varian)
# base_url = "https://www.walmart.com/ip/Rimmel-Just-Let-it-Go-Gentle-Eye-Makeup-Remover-3-4-fl-oz/15942202274"
...
#         print(f"   -> Title: {title[:80]}...") # Tampilkan sebagian
        
#         # Tambahkan jeda waktu singkat (delay) untuk menghindari pemblokiran oleh server
#         time.sleep(1.5) 
